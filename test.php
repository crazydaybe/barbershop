...
<body id="top">
  ...
  <header class="header">
      ...
      <div class="container">
        ...
        <ul class="header-top-list">
          ...
          <li class="header-top-item">
            ...
            <a href="tel:01234567895" class="item-link">(+63) 999 302 2003</a>
          </li>
          ...
          <li class="header-top-item">
            ...
            <p class="item-text">Monday - Sunday, 08 am - 07 pm</p>
          </li>
    ...
    <div class="header-bottom" data-header>
      <div class="container">
        ...
        <a href="#" class="logo">
         Davidson's
          <span class="span">Barbershop</span>
        </a>
        ...
        <nav class="navbar container" data-navbar>
          <ul class="navbar-list">
            ...
            <li class="navbar-item">
              <a href="update_profile.php" class="navbar-link" data-nav-link>Profile</a>
            </li>
        ...
        <a href="selectservices.php" class="btn has-before">
          <span class="span">RECORD SERVICES</span>
            ...
            <ul class="grid-list">
              ...
              <li data-filter="shaving">
                <div class="pricing-card">
                  ...
                  <data class="card-price" value="90">₱90</data>
              ...
              <li data-filter="shaving">
                <div class="pricing-card">
                  ...
                  <data class="card-price" value="60">₱60</data>
  ...
  <footer id="footer" class="footer has-bg-image" style="background-image: url('./assets/images/footer-bg.png')">
    <div class="container">
              ...
              <div class="blog-card">
                ...
                <div class="card-content">
                  ...
                  <div class="card-date">
                    ...
                    <time datetime="2024-08-25">25 October 2024</time>
                  </div>
                </div>
          ...
          <ul class="footer-list">
            ...
            <li class="footer-list-item">
              ...
              <address class="contact-link">
                National Highway P3 Magsaysay, Cordon, Isabela
              </address>
            </li>
            ...
            <li class="footer-list-item">
              ...
              <a href="tel:+0123456789" class="contact-link">+(+63) 999 302 2003</a>
            </li>

            <li class="footer-list-item">
              <ion-icon name="time-outline" aria-hidden="true"></ion-icon>

              <span class="contact-link">Monday - Sunday, 08 am - 07 pm</span>
            </li>

            <li class="footer-list-item">
              <ion-icon name="mail-outline" aria-hidden="true"></ion-icon>

              <a href="mailto:support@gmail.com" class="contact-link">davidsonsbarbershop@gmail.com</a>
            </li>
